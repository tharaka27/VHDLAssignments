...
HD_PWD='C:/Users/94776/assignment_1/assignment_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log schematicFile.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source schematicFile.tcl -notrace
