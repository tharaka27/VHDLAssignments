...
HD_PWD='C:/Users/94776/assignment_1/assignment_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log schematicFile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source schematicFile.tcl
